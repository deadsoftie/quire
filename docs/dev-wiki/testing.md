...
checked - layout, real user interaction, visual appearance. Automated tests prove the
logic; a manual pass in the running app is what's trusted for "does this actually look
and feel right."
