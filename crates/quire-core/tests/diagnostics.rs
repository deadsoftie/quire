...
/// Compiles `body` (wrapped in a minimal preamble) as the root document's dirty-buffer content --
/// no fixture per test case needed, and every diagnostic comes from the real Tectonic engine.
